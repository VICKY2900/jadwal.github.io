...
<head>
  ...
  <title>Administrator - Sistem Informasi Jadwal Karyawan TVRI</title>
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="jadwal.php">
            <i class="bi bi-calendar2-week"></i> <span> Data Jadwal</span>
          </a>
        </li>

        <li class="nav-item">
          <a class="nav-link active" href="bc.php">
            <i class="bi bi-envelope"></i> <span> Broadcast Jadwal</span>
          </a>
        </li>

        <li class="nav-item">
          <a class="nav-link active" href="user.php">
            <i class="bi bi-people"></i> <span> Data Admin</span>
          </a>
        </li>
